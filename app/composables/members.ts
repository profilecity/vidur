...
import type { addMemberSchema, removeMemberSchema } from '~~/shared/schemas/setting';
...
export async function useMembersRepository() {
  return useObjectRepository<Admin[], never, never, never, CreateMember, never, RemoveMember>({
