<template>
  <div class="w-full md:w-1/2 mx-auto">
    <div class="min-h-[100dvh] h-full flex flex-col after:flex-1">
          ...
          <div class="max-w-md mx-auto w-full">
            <div class="relative">
              ...
              <ul class="relative flex justify-between w-full">
                <li>
                  <NuxtLink
                    class="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-zinc-900 text-white"
                    to="/onboarding/step-1">1</NuxtLink>
                </li>
                <li>
                  <NuxtLink
                    class="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-zinc-900  text-white"
                    to="/onboarding/step-2">2</NuxtLink>
                </li>
                <li>
                  <NuxtLink
                    class="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-white  text-gray-500"
                    to="/onboarding-03">3</NuxtLink>
                </li>
                <li>
                  <NuxtLink
                    class="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-white  text-gray-500"
                    to="/onboarding-04">4</NuxtLink>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="px-4 -mt-56">
        <div class="max-w-md mx-auto">

          <h1 class="text-2xl text-gray-800 font-bold mb-6 font-noto">Tell us about your requirements</h1>
          <!-- Form -->
          <form>
            <div class="sm:flex space-y-3 sm:space-y-0 sm:space-x-4 mb-8">
              <label class="flex-1 relative block cursor-pointer">
                ...
                <div
                  class="h-full text-center bg-white px-4 py-6 rounded-lg border border-gray-200 hover:border-gray-300 shadow-sm transition">
                  ...
                  <div class="font-semibold text-gray-800 mb-1">Freelancer / Indivisual</div>
                  <div class="text-sm">Hiring for personal requirements.</div>
                </div>
                <div
                  class="absolute inset-0 border-2 border-transparent peer-checked:border-zinc-700 rounded-lg pointer-events-none"
                  aria-hidden="true"></div>
              </label>
              <label class="flex-1 relative block cursor-pointer">
                <input type="radio" name="radio-buttons" class="peer sr-only" />
                <div
                  class="h-full text-center px-4 py-6 rounded-lg border border-gray-200 hover:border-gray-300 shadow-sm transition">
                  <svg class="inline-flex fill-current text-zinc-800 mt-2 mb-4" xmlns="http://www.w3.org/2000/svg"
                    width="24" height="24" viewBox="0 0 24 24">
                    <path
                  ...
                  <div class="font-semibold text-gray-800 mb-1">Recruiter</div>
                  <div class="text-sm">Hiring as a recruiter for an Organization.</div>
                </div>
                <div
                  class="absolute inset-0 border-2 border-transparent peer-checked:border-zinc-700 rounded-lg pointer-events-none"
                  aria-hidden="true"></div>
            ...
            <div class="flex items-center justify-between space-x-6 mb-8">
              <div>
                <div class="font-bold text-gray-800 text-sm mb-1">💸 Would you like to join our mailing list?</div>
                <div class="text-xs">By agreeing, you consent to receiving marketing / product updates via emails. You can unsubscribe anytime.</div>
              </div>
