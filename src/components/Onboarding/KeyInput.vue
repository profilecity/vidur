  ...
  <section class="flex items-center justify-center min-h-screen">
    <div class="max-w-sm mx-auto w-full text-center">
      ...
      <form class="justify-center mt-10">
        <InputText id="input-key" label="To get started, enter the one-time setup code." placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" v-model="key"/>
        <InputLabel label="You can find the key in standard logs of the server." label-class="text-xs text-zinc-400" id="random"/>
