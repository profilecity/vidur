    ...
    <div class="">
        ...
        <div class="px-4 space-y-6 w-full items-center mt-4">
            ...
            <section class="w-full md:w-2/3">
                <div class="flex items-end">
                    <div class="mr-4">
                        <img class="w-16 h-16 md:w-20 md:h-20 rounded-xl" src="https://careers.thenirvanalabs.com/company-logo.png" width="80" height="80"
                            alt="User upload" />
                    </div>
                    <button class="px-4 py-2 bg-zinc-900 border border-zinc-900 text-sm rounded-xl hover:bg-zinc-700 text-white">Save</button>
                </div>
                <div class="md:flex gap-4 items-center mt-5">
                    <div class="w-full md:w-2/3">
                        ...
                        <input 
                            class="w-full block py-2 px-4 border border-zinc-200 rounded-xl text-sm placeholder:text-zinc-400 focus:ring-1 focus:ring-inset focus:ring-zinc-300 sm:text-sm sm:leading-6 outline-0"
                            type="text"
                ...
                <div class="w-full mt-5">
                    ...
                    <div class="flex space-x-2">
                        <input 
                            class="w-full block py-2 px-4 border border-zinc-200 rounded-xl text-sm placeholder:text-zinc-400 focus:ring-1 focus:ring-inset focus:ring-zinc-300 sm:text-sm sm:leading-6 outline-0"
                            type="text" placeholder="Mars Mission Docs" />
                        <input 
                            class="w-full block py-2 px-4 border border-zinc-200 rounded-xl text-sm placeholder:text-zinc-400 focus:ring-1 focus:ring-inset focus:ring-zinc-300 sm:text-sm sm:leading-6 outline-0"
                            type="url" placeholder="https://big-space-tech.com/missions/mars" />
                    </div>
                </div>
            </section>
        </div>
        ...
        <div class="px-4 space-y-6 w-full items-center mt-4">
            <section class="w-full md:w-1/3">
                ...
                <h4 class="text-sm mb-5 text-zinc-400">These settings help your website rank better and enable better device previews.</h4>
            </section>
            <section class="w-full md:w-2/3">
                <div class="md:flex gap-4 items-center mt-5">
                    <div class="w-full md:w-2/3">
                        <label class="block text-sm font-medium mb-1 text-zinc-900" for="name">Website Title</label>
                        <input class="w-full block py-2 px-4 border border-zinc-200 rounded-xl text-sm placeholder:text-zinc-400 focus:ring-1 focus:ring-inset focus:ring-zinc-300 sm:text-sm sm:leading-6 outline-0"
                            type="text" placeholder="Organization Name" v-model="seoTitle">
                    ...
                    <div class="w-full md:w-2/3">
                        ...
                        <input class="w-full block py-2 px-4 border border-zinc-200 rounded-xl text-sm placeholder:text-zinc-400 focus:ring-1 focus:ring-inset focus:ring-zinc-300 sm:text-sm sm:leading-6 outline-0"
                            type="text" placeholder="We build space tech" v-model="seoDescription" />
                        <div class="text-xs mt-1 text-rose-500">{{ errors['seo.description'] }}</div>
                    </div>
                </div>
                <div class="md:flex gap-4 items-center mt-5">
                    <div class="w-full md:w-2/3">
                        <label class="block text-sm font-medium mb-1 text-zinc-900" for="name">Twitter Handle (without @)</label>
                        <input class="w-full block py-2 px-4 border border-zinc-200 rounded-xl text-sm placeholder:text-zinc-400 focus:ring-1 focus:ring-inset focus:ring-zinc-300 sm:text-sm sm:leading-6 outline-0"
                            type="text" placeholder="the_nirvana_labs" v-model="seoTwitter">
                    ...
                    <div class="w-full md:w-2/3">
                        ...
                        <input class="w-full block py-2 px-4 border border-zinc-200 rounded-xl text-sm placeholder:text-zinc-400 focus:ring-1 focus:ring-inset focus:ring-zinc-300 sm:text-sm sm:leading-6 outline-0"
                            type="text" placeholder="careers, space, technology, jobs..." v-model="seoKeywords"/>
